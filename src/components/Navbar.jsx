...
import myPhoto from "../assets/pics/haddd.jpg";
  ...
  const profileMenus = [
    {
      id: 1,
      title: "Profile",
      url: "https://personalwebjihaddd.vercel.app/",
    },
    {
      id: 2,
      title: "Instagram",
      url: "https://www.instagram.com/ylsaysr",
    },
  ];
  return (
      ...
      <main className="flex items-center justify-between w-full p-5 lg:py-7 lg:px-10 max-w-screen-2xl">
        <div className="left flex items-center gap-10">
          <a className="logo-container w-[100px]" href="#">
            <h1 className="text-3xl text-red-700 font-bold">Deccaaa</h1>
          </a>
